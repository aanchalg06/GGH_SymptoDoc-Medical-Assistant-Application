...
import com.aanchal.symptodoc.presentation.common.NewTextButotn
import com.aanchal.symptodoc.presentation.components.OnBoardingPage
import com.aanchal.symptodoc.presentation.components.PageIndicator
import kotlinx.coroutines.launch


@OptIn(ExperimentalFoundationApi::class)
@Composable
fun OnBoardingScreen(navController: NavHostController, viewModelmain: MainViewModel) {
            ...
            verticalAlignment = Alignment.CenterVertically)
        {
            ...
            Row(verticalAlignment = Alignment.CenterVertically){
                ...
                if(buttonState.value[0].isNotEmpty()){
                    NewTextButotn(text = buttonState.value[0],
                        onClick = {
                            scope.launch{
                ...
                NewTextButotn(text = buttonState.value[1], onClick = {
                    scope.launch {
